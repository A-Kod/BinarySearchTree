...
SCENARIO("we must get two same trees_2")
{
    GIVEN("two trees")
    {
        tree1 = BinarySearchTree<int>({5, 2, 1});
        tree2 = BinarySearchTree<int>({5, 2});
...
SCENARIO("we must get two same trees_3")
{
    GIVEN("two trees")
    {
        tree1 = BinarySearchTree<int>({5, 2, 1, 3});
        tree2 = BinarySearchTree<int>({5, 2, 3});
...
SCENARIO("we must get two same trees_4")
{
      GIVEN("two trees")
      {
        tree1 = BinarySearchTree<int>({5, 2, 1, 3, 6, 7});
        tree2 = BinarySearchTree<int>({5, 1, 3, 6, 7});
...
SCENARIO("we must get two same trees_6")
{
        GIVEN("two trees")
        {
        tree1 = BinarySearchTree<int>({1, 2, 3, 4, 5});
        tree2 = BinarySearchTree<int>({1, 2, 3, 4, 5});
